		...
		<div className='taskList'>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[8]['description']}</div>
					<p>estimated completion time: 8 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart1 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet1(false);
								loadSet1(true);
								setTimeout(task1, robotTasks[8]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[22]['description']}</div>
					<p>estimated completion time: 6 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart2 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet2(false);
								loadSet2(true);
								setTimeout(task2, robotTasks[22]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[23]['description']}</div>
					...
					{buttonStart3 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet3(false);
								loadSet3(true);
								setTimeout(task3, robotTasks[23]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[24]['description']}</div>
					<p>estimated completion time: 2 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart4 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet4(false);
								loadSet4(true);
								setTimeout(task4, robotTasks[24]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[25]['description']}</div>
					<p>estimated completion time: 5 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart5 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet5(false);
								loadSet5(true);
								setTimeout(task5, robotTasks[25]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='completedBox'>
				...
				{task1Start ? (
					<div className='completed'>{robotTasks[8]['description']} ✓</div>
				) : null}
				<br />
				{task2Start ? (
					<div className='completed'>{robotTasks[22]['description']} ✓</div>
				) : null}
				<br />
				{task3Start ? (
					<div className='completed'>{robotTasks[23]['description']} ✓</div>
				) : null}
				<br />
				{task4Start ? (
					<div className='completed'>{robotTasks[24]['description']} ✓</div>
				) : null}
				<br />
				{task5Start ? (
					<div className='completed'>{robotTasks[25]['description']} ✓</div>
				) : null}
				<br />
			</div>
		</div>
