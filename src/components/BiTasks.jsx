		...
		<div className='taskList'>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[1]['description']}</div>
					...
					{buttonStart1 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet1(false);
								loadSet1(true);
								setTimeout(task1, robotTasks[1]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[5]['description']}</div>
					...
					{buttonStart2 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet2(false);
								loadSet2(true);
								setTimeout(task2, robotTasks[5]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[13]['description']}</div>
					...
					{buttonStart3 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet3(false);
								loadSet3(true);
								setTimeout(task3, robotTasks[13]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[14]['description']}</div>
					<p>estimated completion time: 30 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart4 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet4(false);
								loadSet4(true);
								setTimeout(task4, robotTasks[14]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[15]['description']}</div>
					...
					{buttonStart5 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet5(false);
								loadSet5(true);
								setTimeout(task5, robotTasks[15]['eta']);
							}}
						>
							Complete Task
						</button>
				...
				<div className='completedBox'>
					...
					{task1Start ? (
						<div className='completed'>{robotTasks[1]['description']} ✓</div>
					) : null}
					<br />
					{task2Start ? (
						<div className='completed'>{robotTasks[5]['description']} ✓</div>
					) : null}
					<br />
					{task3Start ? (
						<div className='completed'>{robotTasks[13]['description']} ✓</div>
					) : null}
					<br />
					{task4Start ? (
						<div className='completed'>{robotTasks[14]['description']} ✓</div>
					) : null}
					<br />
					{task5Start ? (
						<div className='completed'>{robotTasks[15]['description']} ✓</div>
					) : null}
					<br />
				</div>
			</div>
