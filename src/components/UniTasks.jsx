...
const UniTasks = () => {
	...
	return (
		<div className='taskList'>
				...
				return (
					<div className='taskWButton'>
						<div className='taskAndTime'>
							<div className='Task'>{robotTasks[taskNum]['description']}</div>
							<p>estimated completion time: 1 sec(s)</p>
						</div>
					</div>
				);
			})}
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[0]['description']}</div>
					<p>estimated completion time: 1 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart1 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet1(false);
								loadSet1(true);
								setTimeout(task1, robotTasks[0]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[4]['description']}</div>
					<p>estimated completion time: 7 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart2 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet2(false);
								loadSet2(true);
								setTimeout(task2, robotTasks[4]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[10]['description']}</div>
					...
					{buttonStart3 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet3(false);
								loadSet3(true);
								setTimeout(task3, robotTasks[10]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[11]['description']}</div>
					<p>estimated completion time: 10 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart4 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet4(false);
								loadSet4(true);
								setTimeout(task4, robotTasks[11]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[12]['description']}</div>
					<p>estimated completion time: 3 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart5 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet5(false);
								loadSet5(true);
								setTimeout(task5, robotTasks[12]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='completedBox'>
				...
				{task1Start ? (
					<div className='completed'>{robotTasks[0]['description']} ✓</div>
				) : null}
				<br />
				{task2Start ? (
					<div className='completed'>{robotTasks[4]['description']} ✓</div>
				) : null}
				<br />
				{task3Start ? (
					<div className='completed'>{robotTasks[10]['description']} ✓</div>
				) : null}
				<br />
				{task4Start ? (
					<div className='completed'>{robotTasks[11]['description']} ✓</div>
				) : null}
				<br />
				{task5Start ? (
					<div className='completed'>{robotTasks[12]['description']} ✓</div>
				) : null}
				<br />
			</div>
		</div>
