		...
		<div className='taskList'>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[9]['description']}</div>
					...
					{buttonStart1 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet1(false);
								loadSet1(true);
								setTimeout(task1, robotTasks[9]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[26]['description']}</div>
					...
					{buttonStart2 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet2(false);
								loadSet2(true);
								setTimeout(task2, robotTasks[26]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[27]['description']}</div>
					<p>estimated completion time: 4 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart3 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet3(false);
								loadSet3(true);
								setTimeout(task3, robotTasks[27]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[28]['description']}</div>
					...
					{buttonStart4 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet4(false);
								loadSet4(true);
								setTimeout(task4, robotTasks[28]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[29]['description']}</div>
					<p>estimated completion time: 15 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart5 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet5(false);
								loadSet5(true);
								setTimeout(task5, robotTasks[29]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='completedBox'>
				...
				{task1Start ? (
					<div className='completed'>{robotTasks[9]['description']} ✓</div>
				) : null}
				<br />
				{task2Start ? (
					<div className='completed'>{robotTasks[26]['description']} ✓</div>
				) : null}
				<br />
				{task3Start ? (
					<div className='completed'>{robotTasks[27]['description']} ✓</div>
				) : null}
				<br />
				{task4Start ? (
					<div className='completed'>{robotTasks[28]['description']} ✓</div>
				) : null}
				<br />
				{task5Start ? (
					<div className='completed'>{robotTasks[29]['description']} ✓</div>
				) : null}
				<br />
			</div>
		</div>
