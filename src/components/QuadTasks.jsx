		...
		<div className='taskList'>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[2]['description']}</div>
					...
					{buttonStart1 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet1(false);
								loadSet1(true);
								setTimeout(task1, robotTasks[2]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[3]['description']}</div>
					...
					{buttonStart2 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet2(false);
								loadSet2(true);
								setTimeout(task2, robotTasks[3]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[16]['description']}</div>
					...
					{buttonStart3 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet3(false);
								loadSet3(true);
								setTimeout(task3, robotTasks[16]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[17]['description']}</div>
					...
					{buttonStart4 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet4(false);
								loadSet4(true);
								setTimeout(task4, robotTasks[17]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='taskWButton'>
				<div className='taskAndTime'>
					<div className='Task'>{robotTasks[18]['description']}</div>
					<p>estimated completion time: 10 sec(s)</p>
				</div>
				<div>
					...
					{buttonStart5 ? (
						<button
							...
							onClick={() => {
								...
								buttonSet5(false);
								loadSet5(true);
								setTimeout(task5, robotTasks[18]['eta']);
							}}
						>
							Complete Task
						</button>
			...
			<div className='completedBox'>
				...
				{task1Start ? (
					<div className='completed'>{robotTasks[2]['description']} ✓</div>
				) : null}
				<br />
				{task2Start ? (
					<div className='completed'>{robotTasks[3]['description']} ✓</div>
				) : null}
				<br />
				{task3Start ? (
					<div className='completed'>{robotTasks[16]['description']} ✓</div>
				) : null}
				<br />
				{task4Start ? (
					<div className='completed'>{robotTasks[17]['description']} ✓</div>
				) : null}
				<br />
				{task5Start ? (
					<div className='completed'>{robotTasks[18]['description']} ✓</div>
				) : null}
				<br />
			</div>
		</div>
